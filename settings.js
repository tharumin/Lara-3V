...
module.exports = {
    OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '94776859364' : process.env.OWNER_NUMBER, //ADD YOUR NUMBER
    SESSION_ID: process.env.SESSION_ID === undefined ? '' : process.env.SESSION_ID, //𝕃𝔸ℝ𝔸-𝕄𝔻=aAYwgawQ#8Byzfbkl7DYzyKXOi8VvCzZ3OaAs9o_IyusbxXM5_2MADD YOUR SSION ID
